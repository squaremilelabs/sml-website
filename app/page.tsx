...
export default function Page() {
  return (
    <main className="flex h-full w-full snap-y snap-mandatory flex-col space-y-4 overflow-auto transition-all lg:flex-row lg:space-x-4 lg:space-y-0">
      {/* LOGO & GREETING BOX */}
      ...
      <section className="grow">
        ...
        <div
          id="contact"
          className="flex h-screen snap-start flex-col items-start justify-start p-4 pt-[180px] lg:items-start lg:pt-8"
        >
          <ContactBox />
        </div>
      </section>
